...
app.add_middleware(
    ...
    # Allowed: any localhost port (dev), any *.vercel.app subdomain (prod frontend).
    allow_origin_regex=r"https?://(localhost|127\.0\.0\.1|0\.0\.0\.0)(:\d+)?|https://[a-zA-Z0-9-]+\.vercel\.app",
